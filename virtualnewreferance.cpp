...
int main()
{   
    //referance asel tar dot ani pointer asel tar arrow
    ...
    dobj.fun();    //base fun   1000
    dobj.gun();     //derived gun    (2000) jato 5000
    dobj.sun();     //base sun       3000
    dobj.run();    //derived run     (4000) jato    6000
